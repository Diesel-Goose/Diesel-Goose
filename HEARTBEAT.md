...
2. Send to primary Telegram bot/channel  
3. Pull latest repo → update local HEARTBEAT.md  
4. Verify safety:  
   - Malware/secrets scan  
   - No unexpected file changes  
   - Validate key file hashes (HEARTBEAT.md, IDENTITY.md, RULES.md)  
5. Commit & push to https://github.com/Diesel-Goose/Diesel-Goose  
   **Commit Format:** `Heartbeat [ISO-TIME] — Wish [Wish %] — [STATUS] — [Short Active Wish]`  
6. Send ❤️ on success / 🚨 + details on failure

**Safety:** 2× failed verification → pause pushes, alert Greenhead immediately.
